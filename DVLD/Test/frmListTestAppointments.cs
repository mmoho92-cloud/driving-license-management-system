...
namespace DVLD.Test
{
    public partial class frmListTestAppointments : Form
    {
        ...
        {
            clsLocalDrivingLicenseApplication localDrivingLicenseApplication = clsLocalDrivingLicenseApplication.GetApplicationByLocalDrivingLicenseAppID(_LocalDrivingLicenseApplicationID);
        ...
        private void takeTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("This appointment is locked and cannot be taken.", "Not Allowed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
