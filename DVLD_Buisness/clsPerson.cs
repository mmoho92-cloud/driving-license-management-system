...
namespace DVLD_Buisness
{
    public class clsPerson
    {
        ...
        {
            return clsPersonData.UppdatePerson(this.PersonID, this.FirstName, this.SecondName, this.ThirdName,
                 this.LastName, this.NationalNo,
                 this.DateOfBirth, this.Gendor, this.Address, this.Phone, this.Email,
                 this.NationalityCountryID, this.ImagePath);
        ...
        {
            return clsPersonData.GetAllPepole();
        }
